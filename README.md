...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pybasemkit-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pybasemkit-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install pybasemkit
```
...
It is possible to list all of the versions of `pybasemkit` available on your platform:
...
```
pixi search pybasemkit --channel conda-forge
```
